...
export const defaultCategoriesConfig: CategoryConfig[] = [
  {
    id: 'ctd',
    name: 'Công tác Đảng - Công tác Chính trị',
    navName: 'CTĐ - CTCT',
    shortLabel: 'CTĐ - CTCT',
    description: 'Bản tin Tuyên huấn, Xây dựng Đảng & Hoạt động Công tác quần chúng',
    subcategories: [
      'Công tác Tuyên huấn',
      'Công tác Tổ chức',
      'Công tác Cán bộ',
  ...
  },
  {
    ...
    navName: 'HUẤN LUYỆN - SSCĐ',
    shortLabel: 'Huấn luyện - SSCĐ',
    description: 'Bản tin Thao trường, Diễn tập, Kỹ thuật Khí tài & Rèn nghiêm kỷ luật',
    subcategories: [
      'Bắn đạn thật',
      'Diễn tập & Cơ động',
  ...
  },
  {
    ...
    navName: 'THỰC HÀNH THEO BÁC',
    shortLabel: 'Thực hành theo Bác',
    description: 'Tỏa sáng phẩm chất cao đẹp "Bộ đội Cụ Hồ" trong thời kỳ mới',
    subcategories: [
      'Lời Bác dạy',
      'Gương sáng chiến sĩ',
      'Kể chuyện Bác Hồ',
  ...
  {
    id: 'doc',
    name: 'Kho Văn bản - Tài liệu Quân sự',
    navName: 'VĂN BẢN - CHỈ THỊ',
    shortLabel: 'Văn bản - Chỉ thị',
    description: 'Hệ thống lưu trữ chỉ thị, nghị quyết, kế hoạch tác chiến & hướng dẫn nghiệp vụ',
    subcategories: [
      'Nghị quyết - Chỉ thị',
  ...
  {
    id: 'lecture',
    name: 'Thư viện Bài giảng điện tử & Giáo án số hóa',
    navName: 'BÀI GIẢNG SỐ',
    shortLabel: 'Bài giảng số',
    description: 'Kho lưu trữ slide trình chiếu, giáo án và học liệu đa phương tiện phục vụ huấn luyện',
    subcategories: [
      'Giáo án Chính trị',
      'Huấn luyện Quân sự',
...
export const defaultSiteConfig: SiteConfig = {
  ...
  homeAnnouncements: [],
  categories_config: defaultCategoriesConfig,

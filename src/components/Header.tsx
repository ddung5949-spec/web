...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="w-full select-none relative z-50">
      ...
      >
        <div className="max-w-7xl mx-auto px-3 sm:px-4 pt-2 sm:pt-2.5 pb-1 sm:pb-1.5 flex flex-col md:flex-row items-center md:items-end justify-between gap-2.5 sm:gap-3">
          {/* Brand Group */}
          <div

...
import { Edit2, FolderArchive, FolderPlus, Plus, Save, Trash2, X, Check, ArrowUpDown, Tag, AlertTriangle } from 'lucide-react';
...
export const DocumentCategoryManagerModal: React.FC<DocumentCategoryManagerModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[120] bg-black/60 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
      <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 w-full max-w-xl overflow-hidden my-auto animate-in fade-in zoom-in-95 duration-200">
        {/* Header */}
        <div className="bg-gradient-to-r from-blue-950 via-blue-900 to-indigo-950 text-white p-4 px-5 flex items-center justify-between border-b-2 border-amber-400">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-blue-100">
                Thêm mới, đổi tên hoặc điều chỉnh các tủ phân loại tài liệu
              </p>
            </div>
          </div>
          <button
        ...
        <div className="p-5 space-y-4 text-xs">
          ...
          <form onSubmit={handleAdd} className="bg-blue-50/70 p-3 rounded-xl border border-blue-200 space-y-2">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 p-2 bg-white border border-blue-300 rounded-lg font-bold text-gray-900 focus:outline-hidden focus:border-blue-700"
              />
              <button
                type="submit"
                className="px-3.5 py-2 bg-blue-800 hover:bg-blue-900 text-white font-bold rounded-lg flex items-center gap-1 shrink-0 transition-colors cursor-pointer"
              >
          ...
          <div className="pt-3 border-t border-gray-200 flex items-center justify-end">
            <button
              type="button"
              onClick={onClose}
              className="px-5 py-2 bg-blue-800 hover:bg-blue-900 text-white font-bold rounded-lg cursor-pointer shadow-xs"
            >
              HOÀN TẤT & ĐÓNG
            </button>
          </div>
